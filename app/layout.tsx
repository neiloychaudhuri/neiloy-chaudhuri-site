...
export const metadata: Metadata = {
  ...
  keywords: ['Software Engineer', 'Neiloy Chaudhuri', 'Full Stack Developer', 'Web Developer', 'React', 'Next.js'],
  authors: [{ name: 'Neiloy Chaudhuri' }],
  openGraph: {
    title: 'Neiloy Chaudhuri | Software Engineer',
    description: 'Personal website of Neiloy Chaudhuri - Software Engineer with a passion for design, systems thinking, and building impactful products.',
    url: 'https://neiloy.dev',
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body className={`${manrope.variable} ${ebGaramond.variable} font-sans antialiased min-h-screen flex flex-col`}>
        <ThemeProvider>
          <Navbar />
